      ...
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="mt-8 flex justify-start gap-6 sm:mt-0 sm:justify-end">
            ...
            <li>
              <a
                href="/https://github.com/ranjithmahesh"
                rel="noreferrer"
                target="_blank"
                className="text-gray-700 transition hover:text-primary/75"
              >
        ...
        <div className="grid grid-cols-1 gap-8 border-t border-gray-100 pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16">
          <div>
            <p className="font-medium text-gray-900">Make Money with Us</p>

            <ul className="mt-6 space-y-4 text-sm">
              <li>
                <a
                  href="#"
                  className="text-gray-700 transition hover:text-primary/75 hover:underline"
                >
                  Sell on Logoipsum
                </a>
              </li>
              ...
              <li>
                <a
                  ...
                  className="text-gray-700 transition hover:text-primary/75 hover:underline"
                >
                  Sell under Logoipsum Accelerator
                </a>
              </li>
...
//           Style Meets Innovation At Our Online Store.At Our Online Store
//         </p>
...
//           <ul className="mt-8 space-y-4 text-sm w-[250px] mx-auto">
//             <li>
//               <a
...
//                 <span className="flex-1 text-gray-700  hover:text-blue-600">
//                   6361283358
//                 </span>
//               </a>
//             </li>
...
//               <address className="-mt-0.5 flex-1 not-italic text-gray-700  hover:text-blue-600">
//                 Bengaluru, Karnataka
//               </address>
//             </li>
//           </ul>
...
//           <a
//             className="inline-block text-primary  underline transition hover:text-blue-600/75"
//             href="#"
//           >
//             Terms & Conditions
//           </a>
